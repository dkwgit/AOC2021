    ...
    public class Program
    {
        ...
        private static void ConfigureServices(IServiceCollection collection)
        {
            collection
                ...
                .AddTransient<IDay, Day12>()
                .AddTransient<IDay, Day13>()
                .AddTransient<IDay, Day14>()
                .AddTransient<IDay, Day15>()
                .AddTransient<IDay, Day16>()
                .AddTransient<IDay, Day17>()
                .AddTransient<IDay, Day18>()
                .AddTransient<IDay, Day19>()
                .AddTransient<IDay, Day20>()
                .AddTransient<IDay, Day21>()
                .AddTransient<IDay, Day22>()
